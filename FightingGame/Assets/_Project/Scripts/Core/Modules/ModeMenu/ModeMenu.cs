...
{
    public partial class ModeMenu : BaseModule, IModeMenu
    {
        ...
        public ModeMenuModel ModeMenuModel => _modeMenuModel;
        private ModeMenuModel _modeMenuModel;
        ...
        {
            _modeMenuModel = (ModeMenuModel)model;
            if (_modeMenuModel == null) return;
